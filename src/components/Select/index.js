...
const Select = ({
    ...
    const changeValue = (newValue) => {
        // on donne la nouvelle valeur à la props "onChange"
        onChange(newValue)
        setValue(newValue)
        // Pour gèrer l'état d'affichage du menu déroulant.
        // S'il est"true", le menu déroulant est fermé, s'il est "false", il est ouvert.
